...
namespace BrainPadApplication
{
    ...
    public static class BrainPad
    {
        ...
        public static void WriteToComputer(int message) => WriteToComputer(message.ToString("N0"));
        public static void WriteToComputer(double message) => WriteToComputer(message.ToString("N4"));
